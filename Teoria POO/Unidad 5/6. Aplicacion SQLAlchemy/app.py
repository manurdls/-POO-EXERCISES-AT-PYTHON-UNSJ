...
def nuevo_usuario():
    if request.method == 'POST':
        if not request.form['nombre'] or not request.form['email'] or not request.form['password']:
            ...
            nuevo_usuario = Usuario(nombre=request.form['nombre'], correo=request.form['email'],
...
def listar_comentarios_usuario():
    if request.method == 'POST':
        if not request.form['usuarios']:
            ...
            #usuario = Usuario.query.get(request.form['usuarios'])
            #print(usuario.comentario)
...
if __name__ == '__main__':
    db.create_all()   # le digo que cree la base de datos
    app.run(debug=True)