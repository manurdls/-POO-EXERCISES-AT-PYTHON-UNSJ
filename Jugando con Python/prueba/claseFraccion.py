...
class Fraccion(object):
    ...
    def __str__(self):
        if self.getDenominador() == 1:
            retorno = str(self.getNumerador())
        else:
            retorno = str(self.__numerador)+'/'+str(self.__denominador)
        return retorno
    ...
    def __add__(self, otro):
        ...
        if result_num == 0:
            ...
            if result.getDenominador() == 1:
                result = result.getNumerador()
